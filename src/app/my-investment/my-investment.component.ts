...
@Component({
  ...
  styleUrls: ['./my-investment.component.css']
})
export class MyInvestmentComponent {
  cardDataList = [
    ...
    {
      id:'2',
      profileImage: 'https://material.angular.io/assets/img/examples/shiba2.jpg',
      title: 'Card 2 Title',
  ...
  visibleCardDataList = this.cardDataList.filter(campaign => campaign.id === '6').slice(0, 12);
  cardsPerLoad = 12;
